    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Text(StringConstants.kLblMyCart)
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                .frame(width: getRelativeWidth(334.0), alignment: .leading)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Text(StringConstants.kLblTotal)
                        ...
                        .frame(width: getRelativeWidth(33.0), height: getRelativeHeight(17.0),
                               alignment: .topLeading)
                    Text(StringConstants.kLbl2098)
                        .font(FontScheme.kInterSemiBold(size: getRelativeHeight(18.0)))
                        .fontWeight(.semibold)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(68.0), height: getRelativeHeight(22.0),
                               alignment: .topLeading)
                        .opacity(0.9)
                }
                .frame(width: getRelativeWidth(68.0), height: getRelativeHeight(40.0),
                       alignment: .top)
